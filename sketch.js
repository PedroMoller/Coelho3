...
var ballon;
var placar,stars0,stars1,stars2;
var placarP = 0;
...
function preload()
{
  ...
  stars0 = loadAnimation("empty.png");
  stars1 = loadAnimation("one_star.png");
  stars2 = loadAnimation("stars.png");
...
function setup() 
{
  ...
  placar.scale = 0.2;
  placar.addAnimation("stars0", stars0);
  placar.addAnimation("stars1", stars1);
  placar.addAnimation("stars2", stars2);
  placar.changeAnimation("stars0")
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star1,20)===true){
    ...
    placarP+=1;
    if(placarP===1){
      placar.changeAnimation("stars1")
     }
     if(placarP===2){
      placar.changeAnimation("stars2")
     }
   }
